 ...
 */
final class Version20240422141358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room_rating ADD CONSTRAINT FK_99C7E0E3DC304035 FOREIGN KEY (salle_id) REFERENCES salle (id)');
